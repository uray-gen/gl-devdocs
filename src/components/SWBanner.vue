			...
			<div class="p-2 rounded-lg bg-discord-green-600 dark:bg-discord-green-700 shadow-lg sm:p-3">
				<div class="flex items-center justify-between flex-wrap">
					...
					<div v-if="needRefresh" class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
						<button
							class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md text-sm font-medium text-gray-200 bg-discord-green-530 dark:bg-discord-green-630 hover:bg-discord-green-460 dark:hover:bg-discord-green-600 focus:outline-none focus-visible:ring-1 focus-visible:ring-white"
