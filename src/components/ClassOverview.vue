			...
			<Disclosure v-slot="{ open }" :default-open="isOpen">
				...
				<DisclosurePanel as="ul" class="no-list !mt-0 pl-2">
					<li
						...
						class="cursor-pointer mb-14 border-l-4 border-transparent rounded-sm hover:border-l-4 hover:border-discord-green-500"
			...
			<Disclosure v-slot="{ open }" :default-open="isOpen">
				...
				<DisclosurePanel as="ul" class="no-list !mt-0 pl-2">
					<li
						...
						class="cursor-pointer border-l-4 border-transparent rounded-sm hover:border-l-4 hover:border-discord-green-500"
