<template>
	...
	>
		<button
			type="button"
			class="rounded-md rounded-l-none rounded-tr-none p-3 inline-flex items-center justify-center text-gray-200 bg-discord-green-600 hover:bg-discord-green-630 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
									...
									<SwitchGroup>
										<div class="flex justify-between px-2">
											...
											<Switch
												...
												:class="usePreferredReducedMotion ? 'bg-discord-green-500' : 'bg-gray-500'"
							...
							<DisclosurePanel as="ul">
								<li v-for="(file, fileId) in category.files" :key="fileId">
									<router-link
										...
										class="text-gray-600 dark:text-gray-300 border-l-4 border-transparent rounded-sm hover:border-l-4 hover:border-discord-green-500 hover:text-gray-800 dark:hover:text-gray-100 group flex items-center px-3 py-2 text-sm font-semibold focus:outline-none focus-visible:ring-1 focus-visible:ring-white"
